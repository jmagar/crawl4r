On this page
  ...
  * [Define hooks for commands](https://code.claude.com/docs/en/slash-commands#define-hooks-for-commands)
  ...
  * [Skill tool](https://code.claude.com/docs/en/slash-commands#skill-tool)
  * [What the Skill tool can invoke](https://code.claude.com/docs/en/slash-commands#what-the-skill-tool-can-invoke)
  * [Encourage Claude to use specific commands](https://code.claude.com/docs/en/slash-commands#encourage-claude-to-use-specific-commands)
  * [Disable the Skill tool](https://code.claude.com/docs/en/slash-commands#disable-the-skill-tool)
  * [Disable specific commands or Skills](https://code.claude.com/docs/en/slash-commands#disable-specific-commands-or-skills)
  * [Skill permission rules](https://code.claude.com/docs/en/slash-commands#skill-permission-rules)
...
`hooks` | Define hooks scoped to this command’s execution. See [Define hooks for commands](https://code.claude.com/docs/en/slash-commands#define-hooks-for-commands). | None  
For example:
```
---
allowed-tools: Bash(git add:*), Bash(git status:*), Bash(git commit:*)
