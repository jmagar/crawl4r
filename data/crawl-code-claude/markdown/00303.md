...
Learn more in the [Agent Skills documentation](https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview) and [Agent Skills API guide](https://platform.claude.com/docs/en/build-with-claude/skills-guide).
  ...
  * [Execute Bash commands](https://platform.claude.com/docs/en/agents-and-tools/tool-use/code-execution-tool#execute-bash-commands)
  * [Create and edit files directly](https://platform.claude.com/docs/en/agents-and-tools/tool-use/code-execution-tool#create-and-edit-files-directly)
  ...
  * [Combine operations](https://platform.claude.com/docs/en/agents-and-tools/tool-use/code-execution-tool#combine-operations)
