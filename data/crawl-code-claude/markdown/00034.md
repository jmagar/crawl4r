...
Depending on what Claude surface you’re building on, here’s how to upload your skill for use: 
  * [Claude.ai](http://claude.ai/redirect/claudedotcom.v1.88e7ef46-2aa6-473a-a011-e30766f69b7f) (Claude apps): Go to **Settings** and add your custom skill there. Custom skills require a Pro, Max, Team, or Enterprise plan with code execution enabled. Skills uploaded here are individual to each user—they are not shared organization-wide and cannot be centrally managed by admins.
...
### **How do I share Skills across my organization?**
**‍** In [Claude.ai](http://claude.ai/redirect/claudedotcom.v1.88e7ef46-2aa6-473a-a011-e30766f69b7f), Skills are currently individual to each user, though org-wide management and sharing capabilities are coming soon. In the meantime, regardless of your team size, we suggest creating a shared document repository with skill specifications. This prepares your organization for upcoming features while establishing good governance practices today.
## **Get started**
Ready to build with Skills? Here's how to start:
[Claude.ai](https://claude.ai/redirect/claudedotcom.v1.88e7ef46-2aa6-473a-a011-e30766f69b7f) users:
...
[Cowork: Claude Code for the rest of your work](https://claude.com/blog/how-to-create-skills-key-steps-limitations-and-examples)Cowork: Claude Code for the rest of your work
...
Agents
[Skills explained: How Skills compares to prompts, Projects, MCP, and subagents ](https://claude.com/blog/how-to-create-skills-key-steps-limitations-and-examples)Skills explained: How Skills compares to prompts, Projects, MCP, and subagents 
...
Agents
[Extending Claude’s capabilities with skills and MCP servers](https://claude.com/blog/how-to-create-skills-key-steps-limitations-and-examples)Extending Claude’s capabilities with skills and MCP servers
...
Product announcements
[Skills for organizations, partners, the ecosystem](https://claude.com/blog/how-to-create-skills-key-steps-limitations-and-examples)Skills for organizations, partners, the ecosystem
...
English (US)
[English (US)](https://claude.com/blog/how-to-create-skills-key-steps-limitations-and-examples)
