On this page
  ...
  * [Try it: add the demo marketplace](https://code.claude.com/docs/en/discover-plugins#try-it%3A-add-the-demo-marketplace)
...
## Next steps
  * **Build your own plugins** : See [Plugins](https://code.claude.com/docs/en/plugins) to create custom commands, agents, and hooks
...
YesNo
[Create plugins](https://code.claude.com/docs/en/plugins)[Agent Skills](https://code.claude.com/docs/en/skills)
