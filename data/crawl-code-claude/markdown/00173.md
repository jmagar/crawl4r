On this page
  ...
  * [Interpreting metrics and events data](https://code.claude.com/docs/en/monitoring-usage#interpreting-metrics-and-events-data)
  ...
  * [Security/privacy considerations](https://code.claude.com/docs/en/monitoring-usage#security%2Fprivacy-considerations)
  * [Monitoring Claude Code on Amazon Bedrock](https://code.claude.com/docs/en/monitoring-usage#monitoring-claude-code-on-amazon-bedrock)
...
YesNo
[Data usage](https://code.claude.com/docs/en/data-usage)[Costs](https://code.claude.com/docs/en/costs)
