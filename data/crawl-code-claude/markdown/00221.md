On this page
  ...
  * [4. Model configuration](https://code.claude.com/docs/en/amazon-bedrock#4-model-configuration)
  * [5. Output token configuration](https://code.claude.com/docs/en/amazon-bedrock#5-output-token-configuration)
