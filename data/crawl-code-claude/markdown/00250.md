On this page
  ...
  * [Run Skills in a forked context](https://code.claude.com/docs/en/skills#run-skills-in-a-forked-context)
  * [Define hooks for Skills](https://code.claude.com/docs/en/skills#define-hooks-for-skills)
  * [Control Skill visibility](https://code.claude.com/docs/en/skills#control-skill-visibility)
  * [When to use each setting](https://code.claude.com/docs/en/skills#when-to-use-each-setting)
  * [Example: model-only Skill](https://code.claude.com/docs/en/skills#example%3A-model-only-skill)
  * [Skills and subagents](https://code.claude.com/docs/en/skills#skills-and-subagents)
  * [Give a subagent access to Skills](https://code.claude.com/docs/en/skills#give-a-subagent-access-to-skills)
  * [Run a Skill in a subagent context](https://code.claude.com/docs/en/skills#run-a-skill-in-a-subagent-context)
...
`allowed-tools` | No | Tools Claude can use without asking permission when this Skill is active. Supports comma-separated values or YAML-style lists. See [Restrict tool access](https://code.claude.com/docs/en/skills#restrict-tool-access-with-allowed-tools).  
...
`user-invocable` | No | Controls whether the Skill appears in the slash command menu. Does not affect the [`Skill` tool](https://code.claude.com/docs/en/slash-commands#skill-tool) or automatic discovery. Defaults to `true`. See [Control Skill visibility](https://code.claude.com/docs/en/skills#control-skill-visibility).  
...
Use `context: fork` and `agent` to run a Skill in a forked subagent with its own separate context. See [Run Skills in a forked context](https://code.claude.com/docs/en/skills#run-skills-in-a-forked-context) for details.
### Distribute Skills
You can share Skills in several ways:
  ...
  * **Managed** : Administrators can deploy Skills organization-wide through [managed settings](https://code.claude.com/docs/en/iam#managed-settings). See [Where Skills live](https://code.claude.com/docs/en/skills#where-skills-live) for managed Skill paths.
