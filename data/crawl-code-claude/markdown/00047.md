...
## Next steps
## [Agent SDK quickstart Build your first agent with Python or TypeScript ](https://platform.claude.com/docs/en/agent-sdk/quickstart)## [CLI reference Explore all CLI flags and options ](https://code.claude.com/docs/en/cli-reference)## [GitHub Actions Use the Agent SDK in GitHub workflows ](https://code.claude.com/docs/en/github-actions)## [GitLab CI/CD Use the Agent SDK in GitLab pipelines ](https://code.claude.com/docs/en/gitlab-ci-cd)
