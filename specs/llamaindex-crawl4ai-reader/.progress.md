...
- [x] 2.8.3a REFACTOR: Acknowledge crawl_with_semaphore wrapper extracted in 2.7.2c - (pending commit)
- [x] 2.8.3b REFACTOR: Acknowledge async context warning in docstring from 2.7.2c - (pending commit)
- [x] 2.8.3c REFACTOR: Verify aload_data tests still pass - (pending commit)

## Current Task

Task 2.8.3: REFACTOR phase complete for aload_data batch loading
...
Task 2.9.1a: Write test for load_data delegates to aload_data (RED)
