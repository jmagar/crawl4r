...
- [x] 2.9.2a GREEN: Implement load_data method - (pending commit)

## Current Task

Task 2.9.2a: GREEN - Implement synchronous load_data wrapper
...
Task 2.9.3a: Add load_data docstring with examples (REFACTOR)
