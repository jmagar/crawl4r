...
class TestQueryExistingFiles:
    ...
    async def test_query_existing_files_from_qdrant(self) -> None:
        ...
        vector_store.scroll.return_value = [
            {"payload": {"file_path": "/home/user/docs/file1.md"}},
            {"payload": {"file_path": "/home/user/docs/file2.md"}},
            {"payload": {"file_path": "/home/user/docs/file3.md"}},
        ]
        ...
        assert len(files) == 3
        assert "/home/user/docs/file1.md" in files
        assert "/home/user/docs/file2.md" in files
        assert "/home/user/docs/file3.md" in files
    ...
    async def test_extract_unique_file_paths(self) -> None:
        ...
        vector_store.scroll.return_value = [
            {"payload": {"file_path": "/home/user/docs/file1.md"}},
            {"payload": {"file_path": "/home/user/docs/file1.md"}},  # Chunk 2
            {"payload": {"file_path": "/home/user/docs/file2.md"}},
            {"payload": {"file_path": "/home/user/docs/file2.md"}},  # Chunk 2
            {"payload": {"file_path": "/home/user/docs/file2.md"}},  # Chunk 3
        ]
    ...
    async def test_extract_modification_dates(self) -> None:
        ...
        # Mock vector store with last_modified_date payloads
        vector_store = AsyncMock()
        vector_store.scroll.return_value = [
            {
                "payload": {
                    "file_path": "/home/user/docs/file1.md",
                    "last_modified_date": "2026-01-01T10:00:00",
                }
            },
            {
                "payload": {
                    "file_path": "/home/user/docs/file1.md",
                    "last_modified_date": "2026-01-01T12:00:00",  # Latest
                }
            },
            {
                "payload": {
                    "file_path": "/home/user/docs/file2.md",
                    "last_modified_date": "2026-01-02T10:00:00",
                }
            },
        ]
        ...
        assert file_dates["/home/user/docs/file1.md"] == datetime.fromisoformat(
            "2026-01-01T12:00:00"
        )
        assert file_dates["/home/user/docs/file2.md"] == datetime.fromisoformat(
            "2026-01-02T10:00:00"
        )
...
class TestFilesystemComparison:
    ...
    async def test_compare_with_filesystem(self) -> None:
        ...
        vector_store.scroll.return_value = [
            {
                "payload": {
                    "file_path": "/home/user/docs/file1.md",
                    "last_modified_date": "2026-01-01T10:00:00",  # Up-to-date
                }
            },
            {
                "payload": {
                    "file_path": "/home/user/docs/file2.md",
                    "last_modified_date": "2026-01-01T10:00:00",  # Stale
                }
            },
            {
                "payload": {
                    "file_path": "/home/user/docs/file3.md",
                    "last_modified_date": "2026-01-01T10:00:00",  # Up-to-date
                }
            },
        ]
        ...
        filesystem_files = {
            "/home/user/docs/file1.md": datetime(2026, 1, 1, 10, 0, 0),  # Up-to-date
            "/home/user/docs/file2.md": datetime(2026, 1, 1, 12, 0, 0),  # Stale (newer)
            "/home/user/docs/file3.md": datetime(2026, 1, 1, 10, 0, 0),  # Up-to-date
            "/home/user/docs/file4.md": datetime(2026, 1, 1, 10, 0, 0),  # New
            "/home/user/docs/file5.md": datetime(2026, 1, 1, 10, 0, 0),  # New
        }
        ...
        assert "/home/user/docs/file2.md" in files_to_process  # Stale
        assert "/home/user/docs/file4.md" in files_to_process  # New
        assert "/home/user/docs/file5.md" in files_to_process  # New
        assert "/home/user/docs/file1.md" not in files_to_process  # Up-to-date
        assert "/home/user/docs/file3.md" not in files_to_process  # Up-to-date
    ...
    async def test_skip_up_to_date_files(self) -> None:
        ...
        vector_store.scroll.return_value = [
            {
                "payload": {
                    "file_path": "/home/user/docs/file1.md",
                    "last_modified_date": "2026-01-01T12:00:00",  # Same as filesystem
                }
            },
            {
                "payload": {
                    "file_path": "/home/user/docs/file2.md",
                    "last_modified_date": "2026-01-01T13:00:00",  # Newer than filesystem
                }
            },
        ]
        ...
        filesystem_files = {
            "/home/user/docs/file1.md": datetime(2026, 1, 1, 12, 0, 0),  # Same
            "/home/user/docs/file2.md": datetime(2026, 1, 1, 12, 0, 0),  # Older
        }
